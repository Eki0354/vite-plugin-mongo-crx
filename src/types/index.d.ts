 ...
 * ```
 */
export const defineDynamicResource: ({ matches, use_dynamic_url, }: Omit<WebAccessibleResourceByMatch, 'resources'>) => WebAccessibleResourceByMatch;
...
export function allFilesReady(): Promise<void>;
...
export function fileReady(script: FileWriterId): Promise<void>;

export const crx: (options: {
